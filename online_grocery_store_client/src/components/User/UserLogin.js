  ...
  const onSubmit = async (e) => {
    ...
    axios({
      ...
      .then(function (response) {
        ...
        console.log(response.data.user_data._id);
        if (response.data.user_data._id) {
          console.log("I entered");
          window.sessionStorage.setItem("user", response.data);
          window.sessionStorage.setItem("user_id", response.data.user_data._id);
          window.sessionStorage.setItem("user_level_id", response.data.user_data.user_level_id);
          window.sessionStorage.setItem("user_name", response.data.user_data.user_name);
          navigate("/dashboard")
        } else {
